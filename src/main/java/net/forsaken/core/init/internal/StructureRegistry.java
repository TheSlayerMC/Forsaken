...
import net.forsaken.common.world.gen.structure.HighestCeilingType;
import net.forsaken.common.world.gen.structure.HighestGroundType;
import net.forsaken.common.world.gen.structure.LowestCeilingType;
import net.forsaken.common.world.gen.structure.LowestGroundType;
...
public class StructureRegistry {
    ...
    public static final DeferredRegister<StructureType<?>> REGISTRY = DeferredRegister.create(Registries.STRUCTURE_TYPE, Forsaken.MOD_ID);
