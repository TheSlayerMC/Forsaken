...
public class JRecipeProvider extends RecipeProvider {
    ...
    protected void addSmithingRecipe(RecipeOutput recipeConsumer, ItemLike input, ItemLike modifier, Item result) {
        //SmithingTransformRecipeBuilder.smithing(Ingredient.of(input), Ingredient.of(modifier), RecipeCategory.MISC, result).unlocks("has_" + modifier.toString().toLowerCase(), has(modifier)).save(recipeConsumer, "forsaken:" + result.getDescriptionId() + "_smithing");
        //TODO FIX
    }
    ...
    public void addOreDefaultItems(RecipeOutput recipeConsumer, RecipePrefix name, ItemLike block, ItemLike oreBlock, ItemLike deepslateOre, ItemLike raw, ItemLike ingot, ItemLike stickItem) {
        ...
        addShieldRecipe(recipeConsumer, ingot,  getItemFromRegistryName("forsaken:" + name.getString() + "shield"));
    ...
    protected void addToolsetRecipes(RecipeOutput recipeConsumer, ItemLike stickItem, ItemLike materialItem, RecipePrefix recipePrefix) {
        addAxeRecipe(recipeConsumer, stickItem, materialItem, getItemFromRegistryName("forsaken:" + (recipePrefix.getString() + "axe")));
        addPickaxeRecipe(recipeConsumer, stickItem, materialItem, getItemFromRegistryName("forsaken:" + recipePrefix.getString() + "pickaxe"));
        addShovelRecipe(recipeConsumer, stickItem, materialItem, getItemFromRegistryName("forsaken:" + recipePrefix.getString() + "shovel"));
        addSwordRecipe(recipeConsumer, stickItem, materialItem, getItemFromRegistryName("forsaken:" + recipePrefix.getString() + "sword"));
        addHoeRecipe(recipeConsumer, stickItem, materialItem, getItemFromRegistryName("forsaken:" + recipePrefix.getString() + "hoe"));
        addMultitoolRecipe(recipeConsumer,
                getItemFromRegistryName(("forsaken:" + recipePrefix.getString() + "axe")), getItemFromRegistryName("forsaken:" + recipePrefix.getString() + "pickaxe")
                , getItemFromRegistryName("forsaken:" + recipePrefix.getString() + "shovel"), getItemFromRegistryName("forsaken:" + recipePrefix.getString() + "hoe")
                , getItemFromRegistryName("forsaken:" + recipePrefix.getString() + "multitool"));

    }

    public void addArmorRecipes(RecipeOutput recipeConsumer, ItemLike materialItem, RecipePrefix recipePrefix) {
        addHelmetRecipe(recipeConsumer, materialItem, getItemFromRegistryName("forsaken:" + (recipePrefix.getString() + "helmet")));
        addChestplateRecipe(recipeConsumer, materialItem, getItemFromRegistryName("forsaken:" + (recipePrefix.getString() + "chestplate")));
        addLeggingsRecipe(recipeConsumer, materialItem, getItemFromRegistryName("forsaken:" + (recipePrefix.getString() + "leggings")));
        addBootsRecipe(recipeConsumer, materialItem, getItemFromRegistryName("forsaken:" + (recipePrefix.getString() + "boots")));
    }
    ...
    public void addDecorType(RecipeOutput recipeConsumer, DeferredBlock<? extends Block> plank, DeferredBlock<? extends Block> stairs, DeferredBlock<? extends Block> wall, DeferredBlock<? extends Block> slab, DeferredBlock<? extends Block> fence, DeferredBlock<? extends Block> gate, DeferredBlock<? extends Block> pressureplate, DeferredBlock<? extends Block> button) {
        ...
        addWallRecipe(recipeConsumer, plank.get(), wall.get());
