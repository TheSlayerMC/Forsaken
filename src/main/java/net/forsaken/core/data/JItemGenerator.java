...
public class JItemGenerator extends BasicFileGenerator {
    ...
    public void generate() {
        for (String name : JItems.itemName) {
            ...
            getNormalItem(Forsaken.MOD_ID, name, JItems.ItemType.ITEM);
            itemModelInit();
        }
        ...
        for (String name : JItems.toolName) {
            ...
            getNormalItem(Forsaken.MOD_ID, name, JItems.ItemType.TOOL);
            itemModelInit();
        }
        ...
        for (String name : JItems.recordName) {
            ...
            getNormalItem(Forsaken.MOD_ID, name, JItems.ItemType.RECORD);
            itemModelInit();
        }
        ...
        for(int i = 0; i < JEntities.entityName.size(); i++) {
            ...
            getSpawnEggItem(Forsaken.MOD_ID, name);
            itemModelInit();
        }
        ...
        for (String name : JItems.gunName) {
            ...
            getGunItem(Forsaken.MOD_ID, name);
            itemModelInit();
        }
        ...
        for (String name : JItems.hammerName) {
            ...
            getHammerItem(Forsaken.MOD_ID, name);
            itemModelInit();
        }
    ...
    public void getGunItem(String modID, String name) {
        ...
        writeToItemModelFile("  \"parent\": \"forsaken:item/gun\",");
    ...
    public void getHammerItem(String modID, String name) {
        writeToItemModelFile("{");
        writeToItemModelFile("  \"parent\": \"forsaken:item/hammer_base\",");
        writeToItemModelFile("  \"textures\": {");
