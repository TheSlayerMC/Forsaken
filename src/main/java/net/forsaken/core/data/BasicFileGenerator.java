...
public class BasicFileGenerator {
    ...
    public void generateBasicFile(String name, String extension) {
        String itemFileDir = "../src/main/resources/assets/forsaken/items/" + name + ".json";
        ...
        getItemFile(Forsaken.MOD_ID, name, extension);
        itemModelInit();
    }
    ...
    public void generateBasicFile(boolean item, String name) {
        ...
        getItemFile(item, Forsaken.MOD_ID, name);
        itemModelInit();
    }
    ...
    public void getShieldItem(String name) {
        ...
        writeToItemFile("      \"base\": \"forsaken:item/" + name + "\",");
        writeToItemFile("      \"model\": {");
        writeToItemFile("        \"type\": \"forsaken:" + name + "\"");
        writeToItemFile("      }");
        writeToItemFile("    },");
        writeToItemFile("    \"on_true\": {");
        writeToItemFile("      \"type\": \"minecraft:special\",");
        writeToItemFile("      \"base\": \"forsaken:item/" + name + "_blocking\",");
        writeToItemFile("      \"model\": {");
        writeToItemFile("        \"type\": \"forsaken:" + name + "\"");
        writeToItemFile("      }");
        writeToItemFile("    },");
    ...
    public void getBowItem(String name) {
        ...
        writeToItemFile("    \"on_false\": {");
        writeToItemFile("      \"type\": \"minecraft:model\",");
        writeToItemFile("      \"model\": \"forsaken:item/" + name + "\"");
        writeToItemFile("    },");
        writeToItemFile("    \"on_true\": {");
        ...
        writeToItemFile("          \"model\": {");
        writeToItemFile("            \"type\": \"minecraft:model\",");
        writeToItemFile("      \"model\": \"forsaken:item/" + name + "_1\"");
        writeToItemFile("          },");
        ...
        writeToItemFile("          \"model\": {");
        writeToItemFile("            \"type\": \"minecraft:model\",");
        writeToItemFile("      \"model\": \"forsaken:item/" + name + "_2\"");
        writeToItemFile("          },");
        ...
        writeToItemFile("        \"type\": \"minecraft:model\",");
        writeToItemFile("      \"model\": \"forsaken:item/" + name + "_0\"");
        writeToItemFile("      },");
