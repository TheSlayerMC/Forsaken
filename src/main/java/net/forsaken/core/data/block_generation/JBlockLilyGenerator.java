...
public class JBlockLilyGenerator extends BasicFileGenerator {

    protected BufferedWriter blockModelWriter, blockstateWriter, itemModelWriter;

    public void generate() {
        for(String name : JBlocks.lilyPadBlockName) {
    ...
    public void getBlockModel(String modID, String name) {
        ...
        writeToBlockModelFile("  \"parent\": \"minecraft:block/lily_pad\",");
