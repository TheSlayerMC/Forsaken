...
public class JBlockWallGenerator extends BasicFileGenerator {
    ...
    public void generate() {
        for(String name : JBlocks.wallBlockName) {
            ...
            String blockModelDir = "../src/main/resources/assets/forsaken/models/block/" + name + "_inventory.json";
            ...
            String blockSideTallModelDir = "../src/main/resources/assets/forsaken/models/block/" + name + "_side_tall.json";
