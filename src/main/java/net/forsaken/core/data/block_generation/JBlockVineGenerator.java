...
public class JBlockVineGenerator extends BasicFileGenerator {

    protected BufferedWriter blockModelWriter, blockstateWriter, itemModelWriter;

    public void generate() {
        for(String name : JBlocks.vineBlockName) {
    ...
    public void getBlockModel(String modID, String name) {
        ...
        writeToBlockModelFile("  \"parent\": \"minecraft:block/vine\",");
        writeToBlockModelFile("  \"textures\": {");
        writeToBlockModelFile("    \"vine\": \"" + modID + ":" + "block/" + name + "\",");
