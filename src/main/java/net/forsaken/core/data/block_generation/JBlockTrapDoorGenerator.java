...
public class JBlockTrapDoorGenerator extends BasicFileGenerator {
    ...
    public void generate() {
        for(String name : JBlocks.trapDoorBlockName) {
            ...
            String blockBottomModelDir = "../src/main/resources/assets/forsaken/models/block/" + name + "_bottom.json";
            String blockTopModelDir = "../src/main/resources/assets/forsaken/models/block/" + name + "_top.json";
