...
public class JBlockEndFrameGenerator extends BasicFileGenerator {
    ...
    public void generate() {
        for(String name : JBlocks.basePortalFrameBlockName) {
            ...
            String blockFilledModelDir = "../src/main/resources/assets/forsaken/models/block/" + name + "_filled.json";
