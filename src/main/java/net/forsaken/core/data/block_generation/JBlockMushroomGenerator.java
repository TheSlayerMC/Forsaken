...
public class JBlockMushroomGenerator extends BasicFileGenerator {
    ...
    public void generate() {
        for(String name : JBlocks.mushroomBlockName) {
            ...
            String blockInsideModelDir = "../src/main/resources/assets/forsaken/models/block/" + name + "_inside.json";
            String blockInventoryModelDir = "../src/main/resources/assets/forsaken/models/block/" + name + "_inventory.json";
            ...
            getBlockInventoryModel(Forsaken.MOD_ID, name);
            getBlockInsideModel(Forsaken.MOD_ID, name);
