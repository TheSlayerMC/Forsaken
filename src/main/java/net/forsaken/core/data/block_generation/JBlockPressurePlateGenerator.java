...
public class JBlockPressurePlateGenerator extends BasicFileGenerator {
    ...
    public void generate() {
        for(String name : JBlocks.pressurePlateBlockName) {
            ...
            String blockPressedModelDir = "../src/main/resources/assets/forsaken/models/block/" + name + "_down.json";
