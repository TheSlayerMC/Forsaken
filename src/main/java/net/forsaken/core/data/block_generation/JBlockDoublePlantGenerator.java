...
public class JBlockDoublePlantGenerator extends BasicFileGenerator {
    ...
    public void generate() {
        for(String name : JBlocks.doublePlantBlockName) {
            ...
            String blockModelDir = "../src/main/resources/assets/forsaken/models/block/" + name + "_bottom.json";
