...
public class JBlockStairsGenerator extends BasicFileGenerator {
    ...
    public void generate() {
        for(String name : JBlocks.stairsBlockName) {
            ...
            String blockInnerModelDir = "../src/main/resources/assets/forsaken/models/block/" + name + "_inner.json";
            String blockOuterModelDir = "../src/main/resources/assets/forsaken/models/block/" + name + "_outer.json";
