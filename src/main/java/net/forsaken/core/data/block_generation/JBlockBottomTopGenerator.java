...
public class JBlockBottomTopGenerator extends BasicFileGenerator {

    protected BufferedWriter blockModelWriter, blockstateWriter, itemModelWriter;

    public void generate() {
        for(String name : JBlocks.topBottomBlockName) {
    ...
    public void getBlockModel(String modID, String name) {
        ...
        writeToBlockModelFile("  \"parent\": \"minecraft:block/cube_bottom_top\",");
