...
public class JBlockPaneGenerator extends BasicFileGenerator {
    ...
    public void generate() {
        for(String name : JBlocks.paneBlockName) {
            ...
            String blockPostModelDir = "../src/main/resources/assets/forsaken/models/block/" + name + "_post.json";
            String blockPostEndsModelDir = "../src/main/resources/assets/forsaken/models/block/" + name + "_post_ends.json";
            String blockPostCapModelDir = "../src/main/resources/assets/forsaken/models/block/" + name + "_cap.json";
            String blockSideModelDir = "../src/main/resources/assets/forsaken/models/block/" + name + "_side.json";
            String blockPostAltCapModelDir = "../src/main/resources/assets/forsaken/models/block/" + name + "_cap_alt.json";
            String blockSideAltModelDir = "../src/main/resources/assets/forsaken/models/block/" + name + "_side_alt.json";
