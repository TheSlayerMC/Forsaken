...
import net.forsaken.core.init.internal.JBlockProperties;
...
public class JBlockGateGenerator extends BasicFileGenerator {
    ...
    public void generate() {
        for(String name : JBlocks.gateBlockName) {
            ...
            String blockModelDir = "../src/main/resources/assets/forsaken/models/block/" + name + ".json";
            String blockOpenModelDir = "../src/main/resources/assets/forsaken/models/block/" + name + "_open.json";
            String blockWallModelDir = "../src/main/resources/assets/forsaken/models/block/" + name + "_wall.json";
            String blockWallOpenModelDir = "../src/main/resources/assets/forsaken/models/block/" + name + "_wall_open.json";
