...
public class JBowItemGenerator extends BasicFileGenerator {
    ...
    public void generate(){
        for(String name : JItems.bowName) {
            ...
            String itemModel0Dir = "../src/main/resources/assets/forsaken/models/item/" + name + "_0.json";
            String itemModel1Dir = "../src/main/resources/assets/forsaken/models/item/" + name + "_1.json";
            String itemModel2Dir = "../src/main/resources/assets/forsaken/models/item/" + name + "_2.json";
