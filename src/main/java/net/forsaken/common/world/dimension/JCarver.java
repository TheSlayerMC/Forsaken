...
import net.forsaken.common.world.carver.BoilCaveCarver;
import net.forsaken.common.world.carver.FrozenCaveCarver;
...
public class JCarver {
    ...
    public static final DeferredRegister<WorldCarver<?>> REGISTRY = DeferredRegister.create(Registries.CARVER, Forsaken.MOD_ID);
