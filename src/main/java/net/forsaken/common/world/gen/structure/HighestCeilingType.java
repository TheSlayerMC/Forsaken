package net.forsaken.common.world.gen.structure;

import com.mojang.serialization.Codec;
import com.mojang.serialization.MapCodec;
import com.mojang.serialization.codecs.RecordCodecBuilder;
import net.forsaken.core.init.internal.StructureRegistry;
...
public final class HighestCeilingType extends Structure {
    ...
    public HighestCeilingType(StructureSettings config,
    ...
    public StructureType<?> type() {
        return StructureRegistry.HIGHEST_CEILING.get();
    }
}